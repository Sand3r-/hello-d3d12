            ...
            D3D12_RECT* scisssorRect)
{
    ...
    mat4 mvpMatrix;
    glm_mat4_mul(g_Context.ViewMatrix, g_Context.ModelMatrix, mvpMatrix);
    glm_mat4_mul(g_Context.ProjectionMatrix, mvpMatrix, mvpMatrix);
